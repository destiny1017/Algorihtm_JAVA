...
//	두 팀의 스킬 레벨 차이의 최솟값을 출력한다.
	...
	public static void main(String[] args) {
		...
		int skillLv[] = new int[4];
		for (int i = 0; i < skillLv.length; i++) skillLv[i] = sc.nextInt();
		int teamA = skillLv[0] + skillLv[3];
		int teamB = skillLv[1] + skillLv[2];
